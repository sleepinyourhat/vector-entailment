...
\centering\resizebox{5.5in}{!}{
  ...
  \begin{tabular}{r r@{ }r r@{ }r r@{ }r r@{ }r r@{ }r} 
    ...
    \midrule
     100\%   & 99.7 &(0.0) & 99.4$^\dagger$ &(0.3)    & 99.6 &(0.0) & \textbf{100.0} &(0.1) & 37.9 &(--)\\
     33\%    & 96.0 &(0.5) & 95.3 &(0.2)     & 95.8 &(0.8)          & 95.5$^\dagger$ &(0.5) & 37.9 &(--)\\
     11\%    & 91.1 &(0.5) & 90.8$^\dagger$ &(0.3)    & 91.3 &(0.6)          & 90.9$^\dagger$ &(0.2) & 37.9 &(--)\\
     % 2\%    & 86.0 &(100.0) & ... &(100.0)   & 86.2 &(100.0)           & 76.4 &(87.3) & 37.9 &(--)\\ % Accidental run with slightly different train/test split.
    \bottomrule
  \end{tabular}}
 \caption{Mean test \% accuracy scores (with standard deviations) on the WordNet data over five-fold crossvalidation. The baseline figure is simply the frequency of the most frequent class, \ii{coordinate}.\label{b-table}} 
\end{table}
