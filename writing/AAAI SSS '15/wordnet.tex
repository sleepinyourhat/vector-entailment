...
\centering\resizebox{5.5in}{!}{
  ...
  \begin{tabular}{r r@{ }r r@{ }r r@{ }r r@{ }r r@{ }r} 
    ...
    \midrule
     100\%   & 99.7 &(0.0) & 99.4$^\dagger$ &(0.3)    & 99.6 &(0.0) & \textbf{100.0}\nodagger &(0.1) & 37.9 &(--)\\
     33\%    & 96.0 &(0.5) & 95.3\nodagger &(0.2)     & 95.8 &(0.8)          & 95.5$^\dagger$ &(0.5) & 37.9 &(--)\\
    ...
    \bottomrule
  \end{tabular}}
 \caption{Mean test \% accuracy scores (with standard deviations) on the WordNet data over five-fold crossvalidation. The baseline figure is the frequency of the most frequent class, \ii{coordinate}.\label{wordnet-table}} 
\end{table}
