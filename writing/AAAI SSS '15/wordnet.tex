...
\centering\resizebox{5.5in}{!}{
  ...
  \begin{tabular}{r r@{ }r r@{ }r r@{ }r r@{ }r r@{ }r} 
    ...
    \midrule
     100\%   & 99.73 &(0.04) & 99.37$^\dagger$ &(0.14)    & 99.61 &(0.02) & \textbf{99.95} &(0.03) & 37.9 &(--)\\
     33\%    & 95.96 &(0.2) & 95.3 &(0.12)                & 95.83 &(0.35)          & 95.45$^\dagger$ &(0.31) & 37.9 &(--)\\
     11\%    & 91.11 &(0.24) & 90.81$^\dagger$ &(0.2)    & 91.27 &(0.27)          & 90.9$^\dagger$ &(0.13) & 37.9 &(--)\\
     % 2\%    & 86.0 &(100.0) & ... &(100.0)   & 86.2 &(100.0)           & 76.4 &(87.3) & 37.9 &(--)\\ % Accidental run with slightly different train/test split.
    \bottomrule
  \end{tabular}}
 \caption{Mean test \% accuracy scores (with standard error) on the WordNet data over five-fold crossvalidation. The baseline figure is simply the frequency of the most frequent class, \ii{coordinate}.\label{b-table}} 
\end{table}
