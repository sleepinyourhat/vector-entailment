\subsection*{Reasoning about semantic relations}\label{sec:join}
...
Figure~\ref{tab:jointable}; cells containing a dot correspond to pairs
...
create boolean structures in which terms denote sets of entities from
