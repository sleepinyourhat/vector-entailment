  ...
  \centering
	...
	%}
        \caption{The model structure used to compare \ii{turtle} and
          \ii{animal}.  learned word representations are fed through
          either an NN or NTN comparison network and then to a softmax
...
settings \cite{holldobler1999approximating,hitzler2004logic}. Our
