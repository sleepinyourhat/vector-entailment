...
\scalebox{0.65}{
 \begin{tikzpicture}
  ...
  \end{tikzpicture}}
   ...
   \caption{The architecture for the sequence sentence model. Nodes in the lower row are learned embeddings and nodes on the upper row are LSTM layers.}\label{fig:model:seq}
