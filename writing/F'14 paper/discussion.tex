...
stronger models---either extended recursive models 
\cite{sochergrounded,kalchbrenner2014convolutional,irsoydeep} or recurrent
ones \cite{sutskever2014sequence}---or the optimization procedures. In addition,
