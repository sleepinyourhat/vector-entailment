...
quantifiers like \ii{most} and \ii{all}. Quantification is far from
...
\begin{table}[tp]
  ...
  \begin{tabular}{ l r@{ \ }r r@{ \ }r r@{ \ }r }
    ...
    \bottomrule
  \end{tabular}
  \caption{\mynote{Performance on the quantifier experiments, given as \% correct and macroaveraged F1.}}
  \label{qresultstable}
\end{table} 
%
