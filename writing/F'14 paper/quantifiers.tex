...
that it can potentially distinguish any two valid sentences except in case the two differ only in the placement of the word \ii{not}, potentially introducing errors into the 58.8\% of examples that contain a sentence with a single
instance of \ii{not}.
