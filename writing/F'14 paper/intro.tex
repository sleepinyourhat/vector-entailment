...
semantic representations for sentences, but it remains an 
...
As with our simulated data, our concern is primarily with the quality of the learned representations and their ability to encode our target semantic relations. Thus, we are less focused on absolute performance than on patterns of accurate and inacccurate predictions, so even this small data set can provide powerful analytic insights into our core representational issues.
