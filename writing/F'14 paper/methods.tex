...
We limit the scope of our experiments in this paper neural network models 
...
% TODO: Say that there are two RNTNs in caption.
...
The word vectors are then looked up from the vocabulary matrix $V$ (one of the model parameters), and
...
and the initialization strategy are all tuned manually. Training times on CPUs vary from hours to days across experiments.
