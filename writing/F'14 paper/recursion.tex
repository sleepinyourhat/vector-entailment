...
% TODO: Enter baseline results, use [[Tree]]RNN.
...
Though imperfect, model performance on the most difficult set of expressions is nonetheless striking. 
