...
plotted on a log scale. The y axis starts at a random-chance accuracy of 33\%. Since the LSTM is trained using SGD with minibatches of 64 examples, and was tuned in that setting, our ability to meaningfully evaluate it on extremely small fractions of the data was limited.}
