...
\midrule
\t{Edit Distance Based}  & \t{71.9} & \t{65.6} & \t{61.9} \\
\t{Classifier Based}     & \t{72.2} & \t{81.7} & \t{61.5} \\
%\midrule
...
Accuracies of two entailment algorithms included in the
...
Our neural network classifier, depicted in \reffig{modelstructure}, is simply a stack of three 200d $\tanh$ layers, with the bottom layer taking the concatenated sentence representations as input and the top layer feeding a softmax classifier, all trained jointly with the sentence embedding model itself.
