...
\t{Unlexicalized}          & \t{49.4} & \t{50.1} & \t{50.4} \\ % Last value was 50.39; rounded for consistency.
\bottomrule
\end{tabular}
\end{center}
% The caption
...
plotted on a log scale. The y axis starts at a random-chance accuracy of 33\%.}
...
(e.g., predicting contradiction for \word{A shopper buys cat food at a
  Walmart}/\word{A person shops for their pet at a store}) indicate
