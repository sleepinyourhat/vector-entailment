...
\todo{Do we need statistics about the number/distribution of workers?}
\todo{Do we need statistics about how much of ImageFlickr we rejected/double-annotated?}
