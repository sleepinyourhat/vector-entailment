...
are summarized in Tables \ref{validation-stats}, \ref{kappas}, and
...
% Does this mean that expected punctuation is missing, or that the
% sentences required little punctuation even by prescriptive
% standards?
