...
\scalebox{0.85}{
 \begin{tikzpicture}
  ...
  \end{tikzpicture}}
        ...
        \caption{The common classification architecture used in all NLI evaluations: for each model evaluated in Table~\ref{tab:nnresults}, two identical copies of the model are run with the two sentences as input, and their outputs are used as the two 50d inputs shown here.}
