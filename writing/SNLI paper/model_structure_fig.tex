...
\scalebox{0.85}{
 \begin{tikzpicture}
  ...
  \end{tikzpicture}}
        ...
        \caption{The classification architecture used in all NLI evaluations: for each sentence embedding model evaluated in \reftabs{tab:nnresults}{tab:transferresults}, two identical copies of the model are run with the two sentences as input, and their outputs are used as the two 100d inputs shown here.}
