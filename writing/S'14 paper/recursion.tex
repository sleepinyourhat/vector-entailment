...
to be able to distinguish if it is to learn this logical system in its
full generality.
...
98.7\% below size four (macro-F1 was above 95.5).  Starting at size
four, performance gradually falls with increasing size.  The RNN model
did not perform well, reaching only 90.5\% (81.4 micro-F1) accuracy on
