...
logic, and Table~\ref{tab:plexs} gives some examples of labelal
statements that we can make in these terms. To compute these labels
...
of formulae and compute the label that holds for each pair.
...
assignments), for which none of the seven label labels in
