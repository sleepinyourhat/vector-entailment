...
Table~\ref{tab:jointable}; blank cells correspond to pairs of relations
for which no valid inference can be drawn in our logic.
...
\begin{table}[htp]
  ...
  %\newcommand{\rcg}{\cellcolor[gray]{.9}}
  \newcommand{\rcg}{}
  $\begin{array}[t]{c@{ \ }|*{7}{c}|}
    %\hline
    \multicolumn{1}{c}{}
