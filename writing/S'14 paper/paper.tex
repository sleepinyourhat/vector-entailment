...
\newcommand{\labeledtreenode}[4][3]{\put(#2){\fcolorbox{#4}{#4}{\makebox(#1,0.3){#3}}}}
...
\title{DRAFT: Logical Structures for Natural Language Reasoning in Recursive Neural Networks}
...
% TODO: Fill in, cite grants, internal reviewers
