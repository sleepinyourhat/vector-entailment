...
between sentences like \ii{No child failed a language exam}, \ii{No
  girl failed a French exam}, and \ii{A boy failed French}. To date,
...
well-understood \cite{Icard:Moss:2013:LILT}.
...
statements like \ii{every reptile walks} and \ii{every turtle moves}.
