...
\begin{picture}(21,7.5)
  ...
  \labeledtreenode[2.3]{11.5,7}{$P(\sqsubset) = 0.8$}{softmaxcolor}  
  \put(11.5,5.7){\vector(0,1){1}}  
  \labeledtreenode[7.75]{11.5,5.4}{all reptiles walk \emph{vs.}~some turtles move}{comparisoncolor}


  \textlabel{8,7}{Softmax classifier}{black}
  \textlabel{4,5.4}{Comparison N(T)N layer}{black}
      
  \textlabel{11.75,3.5}{Composition RN(T)N layers}{black}
