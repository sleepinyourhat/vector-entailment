...
The results for these experiments are shown in Figure \ref{resultstable}. We compare the results to a most frequent class baseline, which reflects the frequency in the test data of most frequent class in the training data, $\natind$.
...
The perfect performance by the RNTN on the
