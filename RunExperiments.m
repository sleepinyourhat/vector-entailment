...
echo "cd quant; lambda = 0.003; lr = 0.1; name=['gradcheck2-', num2str(lr), '-', num2str(lambda)]; disp(name); TrainModel('gradcheck', '', name, 48, 25, lr, lambda, 1, 1);" | /afs/cs/software/bin/matlab_r2012b
...
echo "cd quant; lambda = 0.0005; ed = 0; train = 1; penult = 15, name=['wr-tfrozen-l', num2str(lambda), '-ed', num2str(ed), '-tr', num2str(train), '-pen', num2str(penult)]; disp(name); TrainModel('word-relations', '', name, 64, 25, penult, 0.1, lambda, 1, ed, train);" | /afs/cs/software/bin/matlab_r2012b
...
echo "cd quant; lambda = 0.0005; ed = 2; train = 0; penult = 15, name=['wr-tfrozen-l', num2str(lambda), '-ed', num2str(ed), '-tr', num2str(train), '-pen', num2str(penult)]; disp(name); TrainModel('word-relations', '', name, 64, 25, penult, 0.1, lambda, 1, ed, train);" | /afs/cs/software/bin/matlab_r2012b
