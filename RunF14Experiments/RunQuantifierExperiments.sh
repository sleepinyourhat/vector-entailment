...
export MATLABCMD="cd quant; lambda = 0.0001; dim = 25; td = 1; penult = 75; dropout = 1; tot = 3; name='ql'; eyes = 0.5; TrainModel(''\, 1\, @Quantifiers\, name\, dim\, penult\, td\, lambda\, tot\, eyes\, dropout\, 32);" ; qsub -v MATLABCMD quant/run.sh -q john
export MATLABCMD="cd quant; lambda = 0.000001; dim = 25; td = 1; penult = 75; dropout = 1; tot = 3; name='ql'; eyes = 0.5; TrainModel(''\, 1\, @Quantifiers\, name\, dim\, penult\, td\, lambda\, tot\, eyes\, dropout\, 32);" ; qsub -v MATLABCMD quant/run.sh -q john

export MATLABCMD="cd quant; lambda = 0.01; dim = 25; td = 1; penult = 75; dropout = 1; tot = 2; name='ql'; eyes = 0.5; TrainModel(''\, 1\, @Quantifiers\, name\, dim\, penult\, td\, lambda\, tot\, eyes\, dropout\, 32);" ; qsub -v MATLABCMD quant/run.sh -q john
export MATLABCMD="cd quant; lambda = 0.0001; dim = 25; td = 1; penult = 75; dropout = 1; tot = 2; name='ql'; eyes = 0.5; TrainModel(''\, 1\, @Quantifiers\, name\, dim\, penult\, td\, lambda\, tot\, eyes\, dropout\, 32);" ; qsub -v MATLABCMD quant/run.sh -q john
export MATLABCMD="cd quant; lambda = 0.000001; dim = 25; td = 1; penult = 75; dropout = 1; tot = 2; name='ql'; eyes = 0.5; TrainModel(''\, 1\, @Quantifiers\, name\, dim\, penult\, td\, lambda\, tot\, eyes\, dropout\, 32);" ; qsub -v MATLABCMD quant/run.sh -q john
