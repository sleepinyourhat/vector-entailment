    ...
    methods
            ...
            if (~isempty(obj.daughters))
                ...
                if length(embeddingTransformMatrix) == 0
                    ...
                    for layer = 1:size(embeddingTransformMatrix, 3)
                        obj.transformInnerActivations(:, layer + 1) = (embeddingTransformMatrix(:,:,layer) ...
                    ...
                    % TODO: Make getFeatures use this instead of features.
                    obj.features = obj.transformActivations(:, size(embeddingTransformMatrix, 3));
                end
            end
        end
        ...
        function [ upwardWordGradients, ...
            ...
            elseif hyperParams.trainWords
                ...
                if NUMTRANS > 0
                    [upwardEmbeddingTransformGradients, ...
